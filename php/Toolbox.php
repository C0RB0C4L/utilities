...
class ToolBox
{
	 ...
	 * Each row is an associative array where values are indexed with the corresponding column label.\
	 ...
	 * @return string[]
	 */
	public function convertCsvToArray($filePath, $separator = ";")
	{
		if (is_file($filePath)) {
	 ...
	 */
	public function generateRandomPassword($length = 12, $allowsSpecialChars = false)
	{
